...
-- 插入帖子表数据
INSERT INTO post (title, content, tags, likeCount, collectCount, userId, createTime, updateTime, isDelete)
VALUES
...
-- 插入帖子点赞表数据
INSERT INTO post_like (postId, userId, createTime, updateTime)
VALUES
    (1, 1, NOW(), NOW()),
    (1, 2, NOW(), NOW()),
    (2, 1, NOW(), NOW());
...
-- 插入帖子收藏表数据
INSERT INTO post_collection (postId, userId, createTime, updateTime)
VALUES
    (1, 1, NOW(), NOW()),
    (2, 2, NOW(), NOW()),
    (3, 3, NOW(), NOW());